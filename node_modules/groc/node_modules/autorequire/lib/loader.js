(function() {
  ...
  behavior = (function() {
    if (version[1] === 8 && version[2] >= 0) {
      return require('./loader_behavior/v0.6.10');
    } else if (version[1] === 7 && version[2] >= 2) {
      return require('./loader_behavior/v0.6.10');
    } else if (version[1] === 7 && version[2] >= 0) {
      return require('./loader_behavior/v0.5.2');
    } else if (version[1] === 6 && version[2] >= 10) {
      return require('./loader_behavior/v0.6.10');
    } else if (version[1] === 6 && version[2] >= 0) {
      return require('./loader_behavior/v0.5.2');
    ...
    } else if (version[1] === 4 && version[2] >= 0) {
      return require('./loader_behavior/v0.4.0');
    } else {
